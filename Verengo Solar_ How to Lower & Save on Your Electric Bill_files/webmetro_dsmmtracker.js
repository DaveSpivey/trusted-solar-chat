...
// Client Specific Information *****************************************
	var wm_DSMM_client = "VerengoSolarPlus";
	var wm_DSMM_is1PCCookieEnabled = true; 
	...
	var wm_DSMM_1PCCookieExpirationPeriod = 1000;
	var wm_DSMM_3PCCookieExpirationPeriod = 1000;
// Client Specific Information *****************************************
...
if (!wm_DSMM_NoTrack) {
    ...
    //Device_id
    var wm_DSMM_device = wm_DSMM_qs.get("wm_g_device");
	//MsnDevice_id
	 if (wm_DSMM_device == null) {
        wm_DSMM_device = wm_DSMM_qs.get("wm_m_device");
    }
    var wm_DSMM_dvid = '';
    ...
    else if (wm_DSMM_device == 'm') {
        wm_DSMM_dvid = 2;
    }

    else if (wm_DSMM_device == 'c') {
        wm_DSMM_dvid = 3;
    }
    ...
    if ((wm_DSMM_isPPCTrackingEnabled) && (wm_DSMM_isTrackingEnabled)) {
        if (wm_DSMM_ctid > 0) {
            ...
            if (wm_DSMM_is1PCCookieEnabled) {
                ...
                //Device_id
                wm_DSMM_setCookie("wm_DSMM_dvid_PPC", wm_DSMM_dvid, wm_DSMM_1PCCookieExpirationPeriod);
